// report an incident engineering form
...
const ReportEngineer = ({navigation}) => {
  ...
  const categories = ["Potholes", "Broken Pipes", "Leaning Utility Poles"];
  ...
  const handleReport = async () => {
    try {
      ...
      formData.append("reportType", "Engineering");
