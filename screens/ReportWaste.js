// report an incident waste management form
...
const ReportWaste = ({navigation}) => {
  ...
  const categories = ["Littering", "Illegal Dumping", "Blocked Drains or Waterways"];
  ...
  const handleReport = async () => {
    try {
      ...
      formData.append("reportType", "Waste Management");
